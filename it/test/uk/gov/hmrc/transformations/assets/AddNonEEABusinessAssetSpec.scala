...
class AddNonEEABusinessAssetSpec extends IntegrationTestBase {
  ...
  private lazy val expectedSubsequentGetJson: JsValue =
    JsonUtils.getJsonValueFromFile("5MLD/NonTaxable/transforms/assets/noneeabusiness/add-after-etmp-call.json")

  "an add non-EEA business asset call" should {
