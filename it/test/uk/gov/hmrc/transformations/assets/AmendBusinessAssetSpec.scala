...
class AmendBusinessAssetSpec extends IntegrationTestBase with ScalaFutures {
  ...
  private lazy val expectedSubsequentGetJson: JsValue =
    JsonUtils.getJsonValueFromFile("5MLD/NonTaxable/transforms/assets/business/amend-after-etmp-call.json")

  "an amend business asset call" should {
