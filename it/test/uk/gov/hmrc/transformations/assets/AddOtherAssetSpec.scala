...
class AddOtherAssetSpec extends IntegrationTestBase {
  ...
  private lazy val expectedSubsequentGetJson: JsValue =
    JsonUtils.getJsonValueFromFile("5MLD/NonTaxable/transforms/assets/other/add-after-etmp-call.json")

  "an add other asset call" should {
