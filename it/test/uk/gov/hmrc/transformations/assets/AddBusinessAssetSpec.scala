...
class AddBusinessAssetSpec extends IntegrationTestBase {
  ...
  private lazy val expectedSubsequentGetJson: JsValue =
    JsonUtils.getJsonValueFromFile("5MLD/NonTaxable/transforms/assets/business/add-after-etmp-call.json")

  "an add business asset call" should {
