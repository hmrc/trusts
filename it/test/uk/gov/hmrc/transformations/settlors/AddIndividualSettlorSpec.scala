...
class AddIndividualSettlorSpec extends IntegrationTestBase {
  ...
  "an add individual settlor call" should {
    ...
    "return add data in a subsequent 'get' call, for identifier '0123456789ABCDE'" in assertMongoTest(application) {
      app =>
    ...
    def runTest(identifier: String, application: Application): Assertion = {
      ...
      val addRequest = FakeRequest(POST, s"/trusts/settlors/add-individual/$identifier")
