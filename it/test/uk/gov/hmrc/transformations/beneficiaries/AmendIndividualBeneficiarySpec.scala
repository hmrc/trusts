...
class AmendIndividualBeneficiarySpec extends IntegrationTestBase with ScalaFutures {
  ...
  "an amend individual beneficiary call" should {
    ...
    def runTest(identifier: String, application: Application): Assertion = {
      ...
      val amendRequest = FakeRequest(POST, s"/trusts/beneficiaries/amend-individual/$identifier/0")
        .withBody(payload)
