...
class AddPartnershipAssetSpec extends AsyncFreeSpec with MustMatchers with MockitoSugar with IntegrationTestBase {
  ...
  "an add partnership asset call" - {
    ...
    def runTest(identifier: String, application: Application): Assertion = {
      ...
      val addRequest = FakeRequest(POST, s"/trusts/assets/add-partnership/$identifier")
        .withBody(payload)
