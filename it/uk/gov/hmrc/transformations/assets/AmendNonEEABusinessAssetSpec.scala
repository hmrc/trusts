...
class AmendNonEEABusinessAssetSpec extends IntegrationTestBase with ScalaFutures {
  ...
  private lazy val expectedSubsequentGetJson: JsValue = JsonUtils.getJsonValueFromFile("5MLD/NonTaxable/transforms/assets/noneeabusiness/amend-after-etmp-call.json")

  "an amend non-EEA business asset call" should {
