...
class AmendMoneyAssetSpec extends AsyncFreeSpec with MockitoSugar with IntegrationTestBase with ScalaFutures {
  ...
  private lazy val expectedSubsequentGetJson: JsValue = JsonUtils.getJsonValueFromFile("5MLD/NonTaxable/transforms/assets/money/amend-after-etmp-call.json")
