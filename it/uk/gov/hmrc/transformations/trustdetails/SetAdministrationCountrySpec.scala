...
class SetAdministrationCountrySpec extends AsyncFreeSpec with MustMatchers with MockitoSugar with IntegrationTestBase {

  "a set administration country call" - {
    ...
    def runTest(identifier: String, application: Application): Assertion = {
      ...
      val setValueRequest = FakeRequest(PUT, s"/trusts/$identifier/trust-details/administration-country")
        .withBody(body)
      ...
      val detail = (contentAsJson(subsequentGetResult) \ "administrationCountry").as[JsString]
      detail mustBe body
