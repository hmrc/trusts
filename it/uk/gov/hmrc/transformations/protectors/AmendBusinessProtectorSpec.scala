...
class AmendBusinessProtectorSpec extends IntegrationTestBase with ScalaFutures {
  ...
  "an amend business protector call" should {
    ...
    def runTest(identifier: String, application: Application): Assertion = {
      ...
      val amendRequest = FakeRequest(POST, s"/trusts/protectors/amend-business/$identifier/0")
        .withBody(payload)
