...
object LeadTrusteeType {
  ...
  implicit val leadTrusteeWritesToDes: Writes[LeadTrusteeType] = Writes { leadTrustee =>
...
case class OtherAssetType(description: String, value: Long)
...
case class PartnershipType(description: String, partnershipStart: LocalDate)
