...
object TrusteeIndividualType {
  ...
  val writeToMaintain: Writes[TrusteeIndividualType] = (o: TrusteeIndividualType) =>
    Json
      .obj(
        "lineNo"             -> o.lineNo,
...
object TrusteeOrgType {
  ...
  val writeToMaintain: Writes[TrusteeOrgType] = (o: TrusteeOrgType) =>
    Json
      .obj(
        "lineNo"             -> o.lineNo,
        "bpMatchStatus"      -> o.bpMatchStatus,
