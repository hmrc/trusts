...
object ResponseHeader {
  ...
  val mongoWrites: Writes[ResponseHeader] = (header: ResponseHeader) =>
    Json.obj(
...
case class DisplayTrustEntitiesType(
  naturalPerson: Option[List[DisplayTrustNaturalPersonType]],
...
case class DisplayTrustNaturalPersonType(
...
object DisplayTrustNaturalPersonType {
  ...
  implicit val naturalPersonTypeFormat: Format[DisplayTrustNaturalPersonType] =
    Json.format[DisplayTrustNaturalPersonType]
...
object DisplayTrustLeadTrusteeType {
  ...
  object LeadTrusteeReads extends Reads[DisplayTrustLeadTrusteeType] {
    ...
    override def reads(json: JsValue): JsResult[DisplayTrustLeadTrusteeType] =
      ...
      json
        .validate[DisplayTrustLeadTrusteeIndType]
        .map { leadTrusteeInd =>
          DisplayTrustLeadTrusteeType(leadTrusteeInd = Some(leadTrusteeInd))
        }
        .orElse {
          json.validate[DisplayTrustLeadTrusteeOrgType].map { org =>
...
case class DisplayTrustBeneficiaryType(
  individualDetails: Option[List[DisplayTrustIndividualDetailsType]],
...
case class DisplayTrustBeneficiaryCompanyType(
  lineNo: Option[String],
  bpMatchStatus: Option[String],
...
object DisplayTrustBeneficiaryCompanyType {
  ...
  implicit val companyTypeFormat: Format[DisplayTrustBeneficiaryCompanyType] =
    Json.format[DisplayTrustBeneficiaryCompanyType]
...
case class DisplayTrustProtectorsType(
  protector: Option[List[DisplayTrustProtector]],
...
case class DisplayTrustProtectorCompany(
  lineNo: Option[String],
  bpMatchStatus: Option[String],
  name: String,
  identification: Option[DisplayTrustIdentificationOrgType],
...
case class DisplayTrustSettlors(
  settlor: Option[List[DisplayTrustSettlor]],
...
case class DisplayOtherAssetType(description: String, value: Option[Long])
