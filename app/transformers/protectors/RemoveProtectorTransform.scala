...
case class RemoveProtectorTransform(index: Option[Int], entity: JsValue, endDate: LocalDate, `type`: String)
    extends ProtectorTransform with RemoveEntityTransform
