...
case class RemoveOtherIndividualTransform(index: Option[Int], entity: JsValue, endDate: LocalDate)
    extends OtherIndividualTransform with RemoveEntityTransform
