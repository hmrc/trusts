...
object AmendLargeBeneficiaryTransform {
  val key = "AmendLargeBeneficiaryTransform"

  implicit val format: Format[AmendLargeBeneficiaryTransform] = Json.format[AmendLargeBeneficiaryTransform]
}
