...
case class SetTrustDetailTransform(value: JsValue, `type`: String) extends DeltaTransform with JsonOperations {

  private lazy val path = __ \ 'details \ 'trust \ 'details \ `type`
