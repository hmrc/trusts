...
import models.{NameType, PassportType, ResidentialStatusType, TrustDetailsType, UkType}
import models.variation.{IdentificationType, NaturalPersonType}
import org.scalatest.{FreeSpec, MustMatchers}
import play.api.libs.json.{JsValue, Json}
import transformers.AmendOtherIndividualTransform
import utils.DeedOfVariation.AbsoluteInterestUnderWill
import utils.JsonUtils
import utils.TypeOfTrust.Will
