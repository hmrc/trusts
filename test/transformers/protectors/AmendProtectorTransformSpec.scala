...
class AmendProtectorTransformSpec extends FreeSpec with MustMatchers {
    ...
    "when individual" - {
      ...
      "before declaration" - {
        ...
        "amend a protector details by replacing the protector" in {
          ...
          val transformer = AmendProtectorTransform(1, Json.toJson(amended), original, LocalDate.parse("2020-03-25"), `type`)
      ...
      "at declaration time" - {
        ...
        "set an end date for the original protector, adding in the amendment as a new protector for a protector known by etmp" in {
          ...
          val transformer = AmendProtectorTransform(1, Json.toJson(amended), original, endDate = LocalDate.parse("2020-03-25"), `type`)
        ...
        "amend the new protector that is not known to etmp" in {
          ...
          val transformer = AmendProtectorTransform(2, Json.toJson(amended), original, endDate = LocalDate.parse("2020-03-25"), `type`)
