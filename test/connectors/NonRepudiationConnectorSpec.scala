  ...
  ".nonRepudiationConnector" should {
    ...
    val identityData = IdentityData(
      ...
      credential = CredentialData(
        ...
        loginTimes = LoginTimes(LocalDate.parse("2020-10-10").atStartOfDay(ZoneId.of("Europe/London")).toInstant, None),
        provider = None,
        email = None
      )
    )
    ...
    "return NRS failure responses" when {
      ...
      "return ServiceUnavailableResponse when NRS returns service unavailable" in {
        ...
        val nonRepudiationEndpointUrl = s"/nrs-orchestrator/submission"
        stubNRSPost(server, nonRepudiationEndpointUrl, Json.toJson(payLoad).toString, SERVICE_UNAVAILABLE)
      ...
      "return BadRequestResponse when NRS returns bad request" in {
        ...
        val nonRepudiationEndpointUrl = s"/nrs-orchestrator/submission"
        stubNRSPost(server, nonRepudiationEndpointUrl, Json.toJson(payLoad).toString, BAD_REQUEST)
      ...
      "return BadGatewayResponse when NRS returns bad gateway" in {
        ...
        val nonRepudiationEndpointUrl = s"/nrs-orchestrator/submission"
        stubNRSPost(server, nonRepudiationEndpointUrl, Json.toJson(payLoad).toString, BAD_GATEWAY)
      ...
      "return UnauthorisedResponse when NRS returns unauthorised response" in {
        ...
        val nonRepudiationEndpointUrl = s"/nrs-orchestrator/submission"
        stubNRSPost(server, nonRepudiationEndpointUrl, Json.toJson(payLoad).toString, UNAUTHORIZED)
      ...
      "return GatewayTimeoutResponse when NRS returns gateway timeout response" in {
        ...
        val nonRepudiationEndpointUrl = s"/nrs-orchestrator/submission"
        stubNRSPost(server, nonRepudiationEndpointUrl, Json.toJson(payLoad).toString, GATEWAY_TIMEOUT)
      ...
      "return InternalServerErrorResponse when NRS returns internal server error response" in {
        ...
        val nonRepudiationEndpointUrl = s"/nrs-orchestrator/submission"
        stubNRSPost(server, nonRepudiationEndpointUrl, Json.toJson(payLoad).toString, INTERNAL_SERVER_ERROR)
      ...
      "return ChecksumFailedResponse when NRS returns checksum failed error response" in {
        ...
        val nonRepudiationEndpointUrl = s"/nrs-orchestrator/submission"
        stubNRSPost(server, nonRepudiationEndpointUrl, Json.toJson(payLoad).toString, CHECKSUM_FAILED)
