    ...
    super.applicationBuilder()
      .configure(
        Seq(
          ...
          "microservice.services.ifs-trusts.port" -> server.port(),
          "microservice.services.ifs-display-trust-or-estate.port" -> server.port(),
          "microservice.services.ifs-vary-trust-or-estate.port" -> server.port(),
