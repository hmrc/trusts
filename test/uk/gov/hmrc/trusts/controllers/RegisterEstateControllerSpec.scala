  ...
  ".registration of estate " should {
    ...
    "return 200 with TRN" when {
      ...
      "individual user called the register endpoint with a valid json payload " in {
        ...
        val SUT = new RegisterEstateController(mockDesService, appConfig, validationService, fakeOrganisationAuthAction, rosmPatternService, mockedAuditService, Helpers.stubControllerComponents())
      ...
      "agent user submits estates payload" in {
        ...
        val SUT = new RegisterEstateController(mockDesService, appConfig, validationService, fakeAgentAuthAction,rosmPatternService, mockedAuditService, Helpers.stubControllerComponents())
