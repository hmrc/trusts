...
//
//class RemoveBeneficiariesTransformSpec extends FreeSpec with MustMatchers with OptionValues with MockitoSugar {
//
//  private def originalBeneficiaryJson(value1 : String, endDate: Option[LocalDate] = None) = {
//    val baseFields: Seq[(String, JsValueWrapper)] = Seq ("field1" -> value1, "field2" -> "value20")
//    val fields = endDate.foldLeft(baseFields){(acc, date) => acc :+ ("endDate", date)}
//    Json.obj(fields : _*)
//  }
//
...
////
////      SUT.applyDeclarationTransformations("UTRUTRUTR", "INternalId", inputJson) match {
////        case JsSuccess(value, _) => value mustBe expectedOutput
////        case _ => fail("Transform failed")
////      }
////    }
