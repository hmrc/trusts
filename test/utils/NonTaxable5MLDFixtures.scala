...
object NonTaxable5MLDFixtures extends JsonFixtures {
  ...
  object DES {
    ...
    lazy val get5MLDTrustNonTaxableResponseWithAllAssetTypes: String = getJsonFromFile(
      "5MLD/NonTaxable/des/valid-get-trust-5mld-non-taxable-des-response-with-all-asset-types.json"
    )
  ...
  object Cache {
    ...
    lazy val getTransformedNonTaxableTrustResponse: JsValue = getJsonValueFromFile(
      "5MLD/NonTaxable/cached/transformed-get-non-taxable-trust-response.json"
    )
  ...
  object Trusts {
    ...
    object Assets {
      ...
      lazy val nonTaxable5mldAssets: JsValue = getJsonValueFromFile(
        "5MLD/NonTaxable/trusts/assets/non-taxable-assets.json"
      )
    ...
    lazy val getTransformedNonTaxableTrustResponseWithAllAssetTypes: JsValue = getJsonValueFromFile(
      "5MLD/NonTaxable/trusts/get-trust-transformed-non-taxable-response-with-all-asset-types.json"
    )
